...
class Censor:
    def __init__(self, bias, favored, discount_factor, T, strength):
        self.bias = bias 
    ...
    def update(self):
        p = p_banned(self.society.current_opinions(key='extrinsic'), self.strength, self.favored, self.bias) * self.society.dt 
